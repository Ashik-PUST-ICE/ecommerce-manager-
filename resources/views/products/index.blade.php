...
@section('content')
    <div class="container mx-auto">
        ...
        <a href="{{ route('products.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded mb-4 inline-block">Add
            Product</a>
        <table class="w-full bg-white shadow rounded-lg">
            ...
            <tbody>
                @foreach ($products as $product)
                    <tr>
                        <td class="p-2"><a href="{{ route('products.show', $product) }}"
                                class="text-blue-600">{{ $product->name }}</a></td>
